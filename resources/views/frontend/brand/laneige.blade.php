                    ...
                    <div class="product-grid2">
                        <div class="product-image2">
                            ...
                            <ul class="social">
                                ...
                                <li><a href="{{route('cart.edit',$laneige->id)}}" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                            <a class="add-to-cart" href="{{route('cart.edit',$laneige->id)}}">Add to cart</a>
                        </div>
